...
Fixed: gpt-5.1-codex now uses completions endpoint instead of chat/completions
"""
...
class OpenAIProvider(LLMProvider):
    ...
    Fixed: Now correctly routes codex models to completions endpoint

    🔧 Key Changes:
    - gpt-5.1-codex uses completions endpoint (v1/completions)
    - Other models use chat completions endpoint (v1/chat/completions)
    - Codex models return plain text, other models use JSON mode
    """
        ...
        if self._is_codex_model(self.model):
            ...
            try:
                ...
                return {
                    ...
                    "operation": "UNKNOWN",  # 从 prompt 中无法提取
                    "opcode": "0000",
                    "bitwidth": 16,
...
class LLMFactory:
    ...
    def list_providers() -> Dict[str, Dict[str, str]]:
        ...
        return {
            ...
            "PAID": {
                "openai": "OpenAI GPT (GPT-5 series + Codex supported) - Requires credits",
...
if __name__ == '__main__':
    print("🧪 Testing LLM Provider Module (Fixed for gpt-5.1-codex)\n")
    print("=" * 70)
    ...
    print("\n🔧 Key Fix:")
    print("   ✓ gpt-5.1-codex now uses completions endpoint (v1/completions)")
    print("   ✓ Other models still use chat completions (v1/chat/completions)")